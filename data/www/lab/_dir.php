...
<html lang="fr" itemscope="itemscope" itemtype="http://schema.org/QAPage">
	<head>
		...
		<style media="all" type="text/css">
			...
			div#content > div.container > div.row form#mainForm {
				margin-bottom: 15px;
			}
			...
			a.list-group-item {
				background: url("data:image/png;base64,") no-repeat scroll left 5px center #F1F1F1;
			}

			a.list-group-item.dir {
			...
			a.list-group-item.png, a.list-group-item.jpg, a.list-group-item.tif, a.list-group-item.tiff, a.list-group-item.psd, a.list-group-item.bmp, a.list-group-item.svg, a.list-group-item.jpeg, a.list-group-item.gif {
			...
			a.list-group-item.css, a.list-group-item.xml {
			...
			.list-group .list-group-item:not(.sub):last-of-type:last-child::before {
			...
			.list-group.sub:last-child .list-group-item.sub:last-child {
				border-bottom: 1px solid #ddd !important;
			}

			.list-group.sub:last-child .list-group-item.sub:last-child::after {
				position: absolute;
				top: 0;
				bottom: 0;
				left: -47px;
			...
			.list-group.sub:last-child .list-group-item.sub:last-child::before {
			...
			a.list-group-item:hover, a.list-group-item.sub:hover {
...
$recursive = false;
$response = parse($basedir, $recursive);
